...
{\large\color{mutedgray} Principal Research Software Engineer \textbar{} ML Infrastructure \textbar{} HPC \textbar{} Scientific Computing}\par
\vspace{6pt}

\section{Profile}
Principal research software engineer with 16+ years turning research prototypes into production systems across ML infrastructure, scientific computing, and high-performance computing. Lead developer of UXarray, the standard Python library for unstructured climate-grid analysis at DOE labs and NCAR, including an MCP server that gives AI agents direct, provenance-tracked access to Earth-system meshes on HPC clusters via Globus Compute. Ran 10,000+ cancer-AI training experiments on Summit; ported Pangu-Weather to 60,000+ Intel GPUs on Aurora. Two R\&D 100 Awards (CANDLE 2023, FLASH-X 2022); 480+ citations, h-index 10.
