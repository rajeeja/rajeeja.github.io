...
\skillrow{AI Systems}{MCP server design (typed tools, scoped access, structured provenance), Claude API, LLM tool-use and agent workflows, Globus Compute for HPC-backed agents}
\skillrow{Correctness / Perf}{Numerical analysis (compensated summation, error-free transformations), profiling, review of ported numerical code}
